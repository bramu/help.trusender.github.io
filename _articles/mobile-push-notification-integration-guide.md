...
We're written a help article outlining the correct [AWS IAM policy configuration]({{site.data.links.articles.aws_sns_access_configuration}}) to ensure you can use AWS SNS with Vero.
